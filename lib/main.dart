...
import 'package:makerlab/sprite.dart';
...
var db =  FirebaseDatabase.instance.reference().child("message");
...
class MakerLab extends StatefulWidget {


  @override
  MakerLabState createState() => MakerLabState();
}

Map<dynamic, dynamic> values;

class MakerLabState extends State<MakerLab> with TickerProviderStateMixin {
                          ...
                          return new SimpleDialog(
                            children: <Widget>[
                              new Container(
                                ...
                                child: new ListView(
                                  children: <Widget>[
                                    Text("Car Speed : "+myList ['CARSPEED'],style: TextStyle(fontFamily: 'Code128', fontSize: 40.0)),
                                    Text("DTC", style: TextStyle(fontFamily: 'Code128', fontSize: 40.0)),
                                    new Text( myList ['CARSPEED'],style: TextStyle(fontFamily: 'Code128', fontSize: 40.0)),
                                    new Text( myList ['CARSPEED'],style: TextStyle(fontFamily: 'Code128', fontSize: 40.0)),
                                    new Text( myList ['CARSPEED'],style: TextStyle(fontFamily: 'Code128', fontSize: 40.0)),
                                    new Text( myList ['CARSPEED'],style: TextStyle(fontFamily: 'Code128', fontSize: 40.0)),
                                    new Text( myList ['CARSPEED'],style: TextStyle(fontFamily: 'Code128', fontSize: 40.0)),
...
_openMap() async {
  const url = 'https://www.google.com/maps/search/?api=1&query=35.839188,10.598339';
...
_openAudio() async {
  const url = 'https://www.nrj.fr/webradios/nrj-hits';
  if (await canLaunch(url)) {
    await launch(url);
  } else {
    throw 'Could not launch $url';
...
_openClimate() async {
  const url = 'https://weather.com/en-TT/weather/hourbyhour/l/Ligne+44+FRPL0489:1:FR';
  if (await canLaunch(url)) {
    await launch(url);
  } else {
    throw 'Could not launch $url';
    ...
    return FutureBuilder(
        ...
        builder: (context, data) {
          ...
          if (data.hasData) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              text: " Immeuble Med Wissem Souissi ",
                              style: TextStyle(
                                color: lighTitle,
                              ),
                            ),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          RowItem(title: myList['ODO'], subtitle: "Range"),
                          RowItem(title: myList['FUEL'], subtitle: "Fuel"),
                          RowItem(title: myList['TEMP'], subtitle: "Temp"),
                          RowItem(title: myList['CARSPEED'], subtitle: "Speed"),
                          RowItem(title: myList['RPM'], subtitle: "RPM"),
            ...
            return Positioned(
                top: 210 + -h * 0.18 * ctrl,
                left: 0, child: CircularProgressIndicator());
          }
        });
  }}
...
List<WrapModel> wrapItems = [
  ...
  //WrapModel(Color(0xff26D670), "assets/images/technology.png", "Fuel State"),
  WrapModel(Color(0xffF9262C), "assets/images/transportation.png", "Controls"),
  //WrapModel(Color(0xff1CD6B2), "assets/images/sports.png", "Driver"),
];
